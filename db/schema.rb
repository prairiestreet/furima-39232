...
ActiveRecord::Schema.define(version: 2023_09_11_161216) do
  ...
  create_table "shipping_areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_shipping_areas_on_purchase_record_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "last_name_full_width_katakana", null: false
    t.string "first_name_full_width_katakana", null: false
  ...
  add_foreign_key "shipping_areas", "purchase_records"
end
